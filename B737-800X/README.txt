...
1/ Delete old release (delete all installation folder "XPLANE11/Aircraft/B737-800X")
2/ Copy folder "B737-800X" to "XPLANE11/Aircraft/"
3/ Download and install latest FMOD by AudiobirdXP
4/ Download and install latest TerrainRadar plugin by DrGluck
5/ Enjoy
...
- add new 4k/2k textures by AudioBirdXP
- fixed graphics and other bugs

3.27:
-----
- new improved flight model by Twkster
- new improved graphics textures and EFIS knobs by AudiobirdXP
- corrected systems and gauges (FMC, PFD, ND, APU...)
- add stall shaker for both yokes
- add Oxygen test buttons
- add ISFD features: APP, HP/IN, STD, brightness +/-
- add annuns INSTR SWITCH and DISPLAYS CONTROLS PANEL on PFD
- add acf files for graphics resolution 2K/4K (see folder ACF_2k_4k)
- fixed some bugs
- tested with xplane 11.20r4 and 11.21r2
